    ...
    return (
        <section className={styles.sectionContainer}>
            <header className={styles.sectionTitulo}>
                ...
                <h2 className="light-text">mejoravit.com.mx</h2>
            </header>
            ...
            <div className={`${styles.sectionContenido} light-text`}>
                <p>
                    ...
                    {MEJORAVIT_LINK}. Nosotros recopilamos información personal como su nombre, correo electrónico, número de teléfono y otros cuantos
                    datos relevantes para poder brindarle siempre un mejor servicio y experiencia de usuario en {MEJORAVIT_LINK}. Esta información
                    ...
                    necesidades y preferencias a través de {MEJORAVIT_LINK}.
                </p>

                <p>
                    En {MEJORAVIT_LINK}, no compartimos ni vendemos su información personal a terceros sin su consentimiento previo, excepto en el/los
                    ...
                    así aseguramos que su privacidad esté siempre protegida en {MEJORAVIT_LINK}.
                </p>

                <p>
                    El acceso a la información personal en {MEJORAVIT_LINK} está restringido solo a personal autorizado bajo muy estrictos
                    procedimientos de seguridad. Además, en {MEJORAVIT_LINK}, siempre se utilizan tecnologías avanzadas de encriptación y protocolos
                    de seguridad optimos para asegurar la protección de sus datos en todo momento. Nos aseguramos de que toda la información
                    proporcionada a través del sitio {MEJORAVIT_LINK} esté resguardada contra cualquier amenaza y accesos no autorizados.
                </p>
                ...
                <p>
                    ...
                    puede afectar algunas de las características de {MEJORAVIT_LINK}.
                </p>
                ...
                <p>
                    ...
                    del formulario de contacto que esta disponible en el sitio {MEJORAVIT_LINK}.
                </p>

                <p>
                    En {MEJORAVIT_LINK}, nos aseguraremos de cumplir siempre con todas las leyes y regulaciones de privacidad aplicables, trabajamos
                    ...
                    importantes en nuestra política, se lo notificaremos por medio del sitio web {MEJORAVIT_LINK}.
                </p>
                ...
                <p>
                    ...
                    los medios disponibles en nuestro sitio web {MEJORAVIT_LINK}.
                </p>
                ...
                <p>
                    ...
                    evitar el acceso no autorizado a sus datos. Cada vez que usted visita {MEJORAVIT_LINK}, estamos comprometidos a brindarle siempre
                    la mejor experiencia en línea segura.
                </p>

                <p>
                    En {MEJORAVIT_LINK} también queremos asegurarnos de proporcionar una clara información sobre cómo gestionamos sus datos hoy. Si
